               ...
               <div id="footerContacts">
                  <div id="footerSocialMedia">
                    ...
                    <div class="agrupamentoDosIcones">
                        ...
                        <a href="#" class="iconeDoFooter" id="discord">
                    ...
                    <ul class="footerList">
                      ...
                      <li>
                        <Link style={{textDecoration: 'none'}} class="footerLink" href="/localizacao">
                    ...
                    <div id="inscricaoDoFooter">
                        <h2>Tem interesse em receber nossas notificações?</h2>
                        <p>coloque seu e-mail aqui!</p> 
                        <div id="inputGroup">
